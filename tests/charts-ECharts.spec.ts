...
test.describe("Charts - ECharts Page", async () => {
    ...
    test("@Medium - Visual test for the charts displayed correctly", async ({ page }) => {
        ...
        await allure.step("Visual test - Assert the pie chart displays correctly", async () => {
            await chartsPage.assertPieChart();
        });

        await allure.step("Visual test - Assert the bar chart displays correctly", async () => {
